    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%">
        ...
        <tr><td style="background:#0a0a0a;border-radius:14px 14px 0 0;padding:28px;text-align:center">
          <img src="https://cdn.shopify.com/s/files/1/0922/0911/9605/files/neonframe-logo-black-background_800x800.png?v=1778426735" alt="NeonFrame" height="56" style="display:block;margin:0 auto">
        </td></tr>
        ...
        <tr><td style="background:#fff;padding:32px 32px 24px">
          ...
          <p style="margin:0 0 20px;font-size:15px;font-weight:600;color:#111">Hallo ${firstName}! 👋</p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin:20px 0">
            <tr><td style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:18px 20px">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="34" valign="top" style="font-size:22px">🎁</td>
                  <td style="padding-left:12px">
                    <p style="margin:0 0 6px;font-size:14px;font-weight:600;color:#166534">Exklusives Angebot für Sie</p>
          ...
          <a href="${offerLink}" style="display:block;background:#16a34a;color:#fff;text-align:center;padding:14px;border-radius:10px;font-size:14px;font-weight:600;text-decoration:none;margin-bottom:20px">
          ...
          <p style="margin:0;font-size:12px;color:#555;font-weight:500;line-height:1.6">
